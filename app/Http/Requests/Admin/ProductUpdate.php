...
class ProductUpdate extends FormRequest
{
  ...
  public function rules()
  {
    return [
      ...
      'article' => ['required', 'unique:product,article,' . $this->id . ',product_id'],
      ...
      'material' => ['required'],
      'technic' => ['required'],
      'files' => ['required_without:currentFiles'],
    ];
  }
  ...
  public function messages()
  {
    return [
      ...
      'files.required_without' => 'Поле <strong>Фотография</strong> обязательно для заполнения',
