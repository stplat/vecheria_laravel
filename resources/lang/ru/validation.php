...
return [
  ...
  */
  ...
  'required_without' => 'Поле <strong>:attribute</strong> обязательно для заполнения, когда <strong>:values</strong> не указано.',
  'required_without_all' => 'Поле :attribute обязательно для заполнения, когда ни одно из :values не указано.',
  'same' => 'Значения полей <strong>:attribute</strong> и <strong>:other</strong> должны совпадать.',
  'size' => [
  ...
  */
  ...
  'attributes' => [
    ...
    'ipAddress' => 'IP адрес',
    'limit' => 'Лимит запросов в секунду',
    'position' => 'Должность',
    'file' => 'Файл',
    'gtfsLink' => 'GTFS ссылка',
  ],
];
